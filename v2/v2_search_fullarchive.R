v2_search_fullarchive <- function(token = NULL, product_track = NULL,
                                  query = NULL, start_time = NULL, end_time = NULL, max_results = NULL, next_token = NULL, since_id = NULL, until_id = NULL, expansions = NULL,
  ...
  param_list = v2_validate_request(endpoint = "/2/tweets/search/all", product_track = product_track,
