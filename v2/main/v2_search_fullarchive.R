v2_search_fullarchive <- function(token = NULL, product_track = NULL, stop.condition = NULL,
                                  query = NULL, 
  ...
  param_list = v2_validate_request(v2.endpoint = "/2/tweets/search/all", product_track = product_track,
                                   query = query, 
  ...
  return(param_list)
}; v2_search_fullarchive(query = "btc -is:retweet", max_results = 10, tweet.fields = "all")
